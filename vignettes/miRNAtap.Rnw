...
Targets are aggregated from 4 most commonly cited prediction algorithms: 
DIANA \citep{Maragkakis2011}, Miranda \citep{Enright2003}, PicTar 
\citep{Lall2006} and TargetScan \citep{Friedman2009}.
...
You will need to have R 3.0.0 or later to be able to install and run {\tt 
miRNAtap}.
